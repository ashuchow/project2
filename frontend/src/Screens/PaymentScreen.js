                        ...
                        <div className="tab-content">
                            ...
                            <div id="credit-card" className="tab-pane fade show active pt-3">
                                <form role="form">
                                    <div className="form-group"> <label for="username">
                                            ...
                                            <h6>Card Owner</h6>
                                        </label> <input type="text" name="username" placeholder="Card Owner Name" required className="form-control "/>
                                    </div>
                                    ...
                                    <div className="card-footer"> <Link to="/cnf"><button type="button" className="subscribe btn btn-primary btn-block shadow-sm"> Confirm Payment </button></Link></div>
                                </form>
                            </div>
                            ...
                            <div id="PayTm" className="tab-pane fade show active pt-3">
                                <form role="form">
                                    ...
                                    </label> <input type="number" name="username" placeholder="Number" required className="form-control "/>
                                </div>
                            ...
                            <div className="form-group">
                                <p><Link to="/cnf"><button type="button" className="btn btn-primary "><i className="fas fa-mobile-alt mr-2"></i> Proceed Pyment</button></Link> </p>
                            </div>
